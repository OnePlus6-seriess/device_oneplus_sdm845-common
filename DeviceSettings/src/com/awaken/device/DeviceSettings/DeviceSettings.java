...
import com.awaken.device.DeviceSettings.SuShell;
import com.awaken.device.DeviceSettings.SuTask;
...
import com.awaken.device.DeviceSettings.thermal.ThermalActivity;
...
public class DeviceSettings extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(), com.awaken.device.DeviceSettings.FPSInfoService.class);
            if (enabled) {
