...
import com.awaken.device.DeviceSettings.Constants;
import com.awaken.device.DeviceSettings.DeviceSettings;
...
public class KeyHandler implements DeviceKeyHandler {
    ...
    public static final String CLIENT_PACKAGE_PATH = "/data/misc/awaken/client_package_name";
    ...
    private Context getResContext(Context context) {
        Context resContext;
        try {
            resContext = context.createPackageContext("com.awaken.device.DeviceSettings",
